...
--
-- Host: localhost    Database: pdv_delhpi
-- ------------------------------------------------------
...
CREATE TABLE `clientes` (
  ...
  `cli_endereco` varchar(125) DEFAULT NULL,
  `cli_num` varchar(20) DEFAULT NULL,
  `cli_bairro` varchar(45) DEFAULT NULL,
  `cli_cidade` varchar(45) DEFAULT NULL,
  `cli_fone` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2021-11-28 19:52:26
